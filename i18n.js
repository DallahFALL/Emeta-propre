// =====================================================
// i18n.js — e-META vNext FINAL
// FR / EN / ES / AR
// PARITÉ COMPLÈTE AVEC index.html
// =====================================================
...
window.I18N = {
  ...
  fr: {
    ...
    "field.title.hint": "Une phrase claire et précise qui guidera toute la synthèse.",
    ...
    "field.problem.hint": "Concentrez-vous sur la cause racine du problème.",
    ...
    "field.objectives.hint": "Formulez des objectifs mesurables et hiérarchisés.",
    ...
    "field.constraints.hint": "Mentionnez les éléments pouvant bloquer ou ralentir la décision.",

    "field.kpis.label": "KPIs / indicateurs de succès",
    "field.kpis.ph": "Ex : CA, ROI, NPS, délais, qualité, satisfaction…",
    "field.kpis.hint": "Indicateurs concrets pour évaluer le succès.",
    ...
    "field.context.hint": "Plus le contexte est riche, plus l’analyse sera pertinente.",

    /* GROUP 3 */
    "group.budget": "3) Ambition, budget & délais",
    ...
    "field.consent.label": "J’accepte que mes informations soient utilisées uniquement pour produire mon analyse e-META.",
    "form.trust.note": "Vos données sont strictement confidentielles et ne sont jamais revendues.",
  ...
  en: {
    ...
    "form.intro": "The more precise your inputs, the more relevant the recommendation.",
    "form.help.download": "Download the official guide",
    ...
    "field.decisionType.t3": "Trade-off",
    ...
    "field.title.hint": "One clear sentence that frames the entire analysis.",

    "group.analysis": "2) Structure the analysis",

    "field.problem.label": "Core problem",
    "field.problem.ph": "Describe the real problem.",
    "field.problem.hint": "Focus on root causes, not symptoms.",

    "field.objectives.label": "Priority objectives",
    "field.objectives.ph": "E.g. increase margin, reduce churn…",
    "field.objectives.hint": "Define measurable and ranked objectives.",

    "field.constraints.label": "Constraints & risks",
    "field.constraints.ph": "Budget, timing, regulation…",
    "field.constraints.hint": "Elements that may limit the decision.",

    "field.kpis.label": "KPIs",
    "field.kpis.ph": "Revenue, ROI, NPS…",
    "field.kpis.hint": "Concrete indicators to measure success.",

    "field.resources.label": "Available resources",
    "field.resources.ph": "Team, tools, partners…",

    "field.context.label": "Detailed context",
    "field.context.ph": "History, stakeholders, constraints…",
    "field.context.hint": "More context leads to better analysis.",
    ...
    "field.deadline.ph": "E.g. 1 month, before a specific date…",
    ...
    "field.consent.label": "I agree that my data is used only to generate my e-META analysis.",
    "form.trust.note": "Your data is strictly confidential and never resold.",
  ...
  "hero.badge.text": "Un enfoque estructurado inspirado en las consultoras para aclarar decisiones complejas.",
  "hero.note": "e-META no es un chatbot: es un motor de inteligencia para decisiones.",

  /* HELP */
  "help.title": "¿Necesitas ayuda antes de empezar?",
  ...
  "form.help.download": "Descargar la guía oficial",
  ...
  "field.title.label": "Título de la decisión",
  "field.title.ph": "Ej.: Repensar nuestra estrategia de distribución en Senegal",
  "field.title.hint": "Una frase clara y precisa que guiará toda la síntesis.",
  ...
  "field.problem.hint": "Concéntrate en la causa raíz del problema.",
  ...
  "field.objectives.hint": "Define objetivos medibles y priorizados.",
  ...
  "field.constraints.hint": "Menciona lo que podría bloquear o ralentizar la decisión.",

  "field.kpis.label": "KPIs / indicadores de éxito",
  "field.kpis.ph": "Ej.: ingresos, ROI, NPS, tiempos, calidad, satisfacción…",
  "field.kpis.hint": "Indicadores concretos para medir el éxito.",
  ...
  "field.context.hint": "Cuanto más contexto, más pertinente será el análisis.",
  ...
  "field.outputMode.display": "Mostrar en pantalla",
  ...
  "field.consent.label": "Acepto que mis datos se utilicen solo para generar mi análisis e-META.",
  "form.trust.note": "Tus datos son estrictamente confidenciales y nunca se revenden.",
...
ar: {
  ...
  "hero.subtitle": "يقوم e-META بهيكلة السياق والأهداف والقيود والمؤشرات لتقديم توصية واضحة وقابلة للتنفيذ وموثّقة.",
  ...
  "hero.badge.text": "منهجية منظمة مستوحاة من شركات الاستشارات لتوضيح القرارات المعقدة.",
  ...
  "form.help.download": "تحميل الدليل الرسمي",
  ...
  "field.title.label": "عنوان القرار",
  "field.title.ph": "مثال: إعادة التفكير في استراتيجية التوزيع في السنغال",
  "field.title.hint": "جملة واضحة ودقيقة تقود كامل الملخص.",
  ...
  "field.outputMode.email": "البريد الإلكتروني",
  "field.outputMode.whatsapp": "واتساب",
  "field.outputMode.pdf": "PDF احترافي",
  "field.outputMode.display": "عرض على الشاشة",
  ...
  "field.consent.label": "أوافق على استخدام بياناتي فقط لإنتاج تحليلي عبر e-META.",
  "form.trust.note": "بياناتك سرّية تماماً ولا يتم بيعها أبداً.",
