/* =====================================================
   e-META v4.6 – Multilingue, WhatsApp, Make Webhook, UI
   ===================================================== */

/* --- Webhook Make (fonctionnel) --- */
const MAKE_WEBHOOK_URL = "https://hook.eu2.make.com/0rspbmbatd6to543pejt3hp8gwig0pfn";
...
function applyLanguage(lang) {
  ...
  if (form) {
    ...
    if (resetBtn) resetBtn.textContent = t.btn_reset || "Réinitialiser";
  }
...
document.addEventListener("DOMContentLoaded", () => {
  console.log("e-META v4.6 loaded");
  ...
  if (resetBtn) {
    resetBtn.addEventListener("click", () => {
      const form = document.getElementById("requestForm");
      if (form) form.reset();
      // réappliquer la langue courante (repeuple listes & placeholders)
